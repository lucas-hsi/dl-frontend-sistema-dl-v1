...
$OutFile = Join-Path $AuditDir "http_smoke_corrected.md"
...
"# HTTP Smoke Test Corrigido - Senha Valida - $(Get-Date -Format s)" | Out-File $OutFile -Encoding utf8
W "BASE_URL = $BASE"
...
W ""
W "## Criar usuario via signup (senha valida)"
$signupBody = @{ 
    email = "teste@dl.com"
    password = "teste123456"
    full_name = "Usuario Teste"
}
$signup = Hit -Method POST -Url "$BASE/api/v1/signup" -Body $signupBody

W ""
W "## Login com usuario criado"
$loginBody = @{ email = "teste@dl.com"; password = "teste123456" }
...
Hit -Method POST -Url "$BASE/api/v1/login/access-token" -Body @{ username = "teste@dl.com"; password = "teste123456" } | Out-Null
