...
$OutFile = Join-Path $AuditDir "http_smoke_final.md"
...
"# HTTP Smoke Test Final - Rotas Identificadas - $(Get-Date -Format s)" | Out-File $OutFile -Encoding utf8
W "BASE_URL = $BASE"
...
$loginBody = @{ email = "teste@dl.com"; password = "teste123" }
...
Hit -Method POST -Url "$BASE/api/v1/login/access-token" -Body @{ username = "teste@dl.com"; password = "teste123" } | Out-Null
