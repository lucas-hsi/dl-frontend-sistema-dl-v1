...
export default function ProdutosInativos() {
    // Estados de filtros
    ...
    useEffect(() => {
        setPaginaAtual(1);
    }, [busca, filtroCategoria, filtroCanal, filtroData]);

    const carregarProdutos = async () => {
        try {
            setLoading(true);

            // Usar endpoint específico para produtos inativos
            const data = await api.get('/produtos-estoque/inativos?skip=0&limit=10000');
            const produtosInativos = (data && typeof data === 'object' && 'produtos' in data && Array.isArray((data as any).produtos))
                ? (data as any).produtos.map((produto: any) => ({
            ...
            setProdutos(produtosInativos);
            setTotalProdutos((data && typeof data === 'object' && 'total' in data && typeof (data as any).total === 'number') ? (data as any).total : 0);

            // Extrair opções dos filtros
            const categorias = Array.from(new Set(produtosInativos.map((p: Produto) => p.categoria).filter(Boolean))) as string[];
            setCategoriasDisponiveis(categorias);

        } catch (error) {
            console.error('❌ Erro ao carregar produtos inativos:', error);
            showMessage('carregar_produtos', 'error', 'Erro ao carregar produtos inativos');
            setProdutos([]);
        } finally {
            setLoading(false);
        }
    ...
    const produtosFiltrados = produtos.filter(produto => {
        ...
        return matchBusca && matchCategoria && matchCanal && matchData;
    });
    ...
    const handleExportarDados = () => {
        ...
        a.href = url;
        a.download = "produtos-inativos.csv";
        a.click();
        ...
        <ProtectedRoute>
            <LayoutGestor>
                <div className="w-full max-w-7xl mx-auto space-y-6">
                    ...
                    {/* Header */}
                    <div className="bg-gradient-to-r from-gray-500 to-red-600 rounded-3xl p-6 text-white shadow-xl">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                <Package className="w-12 h-12" />
                                <div>
                                    <h1 className="text-2xl md:text-3xl font-bold mb-1">Produtos Inativos</h1>
                                    <p className="text-gray-100 opacity-90">Produtos com estoque zero ou status inativo</p>
                                </div>
                            </div>
                            <div className="text-right">
                                <div className="text-2xl font-bold">{produtos.length}</div>
                                <div className="text-gray-100 text-sm">produtos inativos</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-2xl p-6 text-white">
                            ...
                            <div className="text-red-100">Sem Estoque</div>
                        </div>
                        <div className="bg-gradient-to-br from-gray-500 to-gray-600 rounded-2xl p-6 text-white">
                            ...
                            <div className="text-gray-100">Status Inativo</div>
                        </div>
                        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 text-white">
                            <div className="text-2xl font-bold">{produtosEsgotados}</div>
                            <div className="text-orange-100">Esgotados</div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl shadow-lg p-6 border border-gray-100">
                        <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
                            <div className="flex flex-wrap items-center gap-3">
                                <button
                                    onClick={() => window.location.href = '/gestor/produtos/estoque'}
                                    className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg flex items-center gap-2"
                                >
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    placeholder="Buscar produtos inativos..."
                                    value={busca}
                                    ...
                                    {loading ? (
                                        <tr>
                                            <td colSpan={8} className="px-6 py-8 text-center">
                                                ...
                                                <p className="mt-2 text-gray-600">Carregando produtos inativos...</p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colSpan={8} className="px-6 py-8 text-center">
                                                ...
                                                <p className="text-gray-600">Nenhum produto inativo encontrado</p>
                                                <p className="text-sm text-gray-500 mt-1">Todos os produtos estão ativos!</p>
                                            </td>
                                        </tr>
                                    ) : (
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                        <div className="bg-white rounded-3xl p-6 w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
                            <div className="flex items-center justify-between mb-6">
                                <h3 className="text-xl font-bold text-gray-800">Detalhes do Produto Inativo</h3>
                                <button
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-lg font-semibold text-red-600">{produtoSelecionado.estoque} unidades</p>
                                        </div>
                                        <div>
                ...
                {showEditarProduto && produtoEdicao && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                        <div className="bg-white rounded-3xl p-6 w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
                            <div className="flex items-center justify-between mb-6">
                                <h3 className="text-xl font-bold text-gray-800">Editar Produto Inativo</h3>
                                <button
